...
class Lambda extends Expr {
    ...
    Value eval(Env env) { return new FValue(env, var, body); }
...
class Apply extends Expr {
    ...
    Value eval(Env env) { return fun.eval(env).enter(arg.eval(env)); }
...
abstract class Value {
    ...
    Value enter(Value val) {
        System.out.println("ABORT: First-Class Function value expected");
        System.exit(1);
...
class FValue extends Value {
    ...
    FValue(Env env, String arg, Expr body) { this.env = env; this.arg = arg; this.body = body; }
